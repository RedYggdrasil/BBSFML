...
{ \
	return (RSfml::UT_cast(lhs) < RSfml::UT_cast(rhs)); \
} \
inline constexpr bool operator<=(EnumClass lhs, EnumClass rhs) \
{ \
	return (RSfml::UT_cast(lhs) <= RSfml::UT_cast(rhs)); \
...
{ \
	return static_cast<EnumClass>((RSfml::UT_cast(lhs) < RSfml::UT_cast(rhs))? lhs : rhs); \
}  \
...
{ \
	return static_cast<EnumClass>(RSfml::UT_cast(lhs) & RSfml::UT_cast(rhs)); \
}\
inline constexpr EnumClass operator|(EnumClass lhs, EnumClass rhs) \
{ \
	return static_cast<EnumClass>(RSfml::UT_cast(lhs) | RSfml::UT_cast(rhs)); \
...
{ \
	return static_cast<EnumClass>(~RSfml::UT_cast(lhs)); \
}\
inline constexpr bool any(EnumClass EInFlag) \
{ \
	return (RSfml::UT_cast(EInFlag)  != (std::underlying_type<EnumClass>::type)0); \
}